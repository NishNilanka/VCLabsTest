...
streamDetails::streamDetails(string mediaFile)
{
...
int streamDetails::initializeStream()
{
...
int streamDetails::showStreamInfo()    
{
...
AVCodec *streamDetails::findDecoder()
{
...
int streamDetails::processframe()
{
	...
	while(res = av_read_frame(pFormatContext,&packet)>=0)
	{
		if(packet.stream_index == video_stream_index){
			...
			if(frameFinished){
				...
				putText(resized, getTime(), Point(5,50), FONT_HERSHEY_DUPLEX, 1, Scalar(0,0,0), 2);
